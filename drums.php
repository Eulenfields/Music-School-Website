...
<html lang="en">
	<head>
		...
		<title>Bateri Derslerimiz | Pena Akademi</title>
				...
				<div class="fullwidth-block inner-content">
					<div class="container">
						<div class="row">
							<div class="col-md-7">
								<div class="content">
									<h2 class="entry-title">Bateri Derslerimiz</h2>
									<figure class="featured-image">
										<img src="dummy/drum-lesson.jpg" alt="post image">
									</figure>
									<p class="leading">Ritmin ve enerjinin merkezi olmaya hazır mısınız? Bateri derslerimiz, başlangıçtan ileri seviyeye kadar herkes için kapsamlı bir öğrenme süreci sunar.</p>
									<p>Bateri derslerimiz, ritim becerilerinizi geliştirmek ve müziğin temposunu hissetmenizi sağlamak için özel olarak tasarlanmıştır. Başlangıç seviyesinde davul setinin kullanımı, temel ritim kalıpları ve el-ayak koordinasyonu üzerine çalışılır. Orta seviyeye geçtiğinizde, farklı tarzlarda dolgu teknikleri, tempo kontrolü ve şarkılarla uyum çalışmaları işlenir. İleri düzeyde öğrenciler, hızlı tempolar, karmaşık dolgu yapıları ve kendi ritimlerini oluşturma üzerinde çalışabilir. Derslerimiz her yaş ve seviyeden öğrenciye hitap eder, birebir destekle ilerlemenize yardımcı olur.</p>
									<br>
							...
							<aside class="sidebar">
									<div class="widget">
										<h3 class="widget-title">Bateri Öğretmenlerimiz</h3>
										<ul class="discography-list">
											<li>
												<figure class="cover"><img src="dummy/drum-teacher1.jpg" alt="thumbnail 1"></figure>
												<div class="detail">
													<h3 id="teacher">Evren Gündüz</h3>
													<span class="year">Rock</span>
													<span class="track">Başlangıç Seviyesi</span>
												</div>
											</li>
											<li>
												<figure class="cover"><img src="dummy/drum-teacher2.jpg" alt="thumbnail 2"></figure>
												<div class="detail">
													<h3 id="teacher">Yavuz Çetin</h3>
													<span class="year">Metal / Hard Rock</span>
													<span class="track">Orta Seviye</span>
												</div>
											</li>
											<li>
												<figure class="cover"><img src="dummy/drum-teacher3.jpg" alt="thumbnail 3"></figure>
												<div class="detail">
													<h3 id="teacher">Berkay Demir</h3>
