...
<html lang="en">
	<head>
		...
		<title>Bas Derslerimiz | Pena Akademi</title>
				...
				<div class="fullwidth-block inner-content">
					<div class="container">
						<div class="row">
							<div class="col-md-7">
								<div class="content">
									<h2 class="entry-title">Bas Gitar Derslerimiz</h2>
									<figure class="featured-image">
										<img src="dummy/bass-lesson.jpg" alt="post image">
									</figure>
									<p class="leading">Ritmin kalbini hissetmek isteyenler için bas gitar derslerimiz tam size göre. Hem müzik teorisi hem de pratik çalışmalarla sağlam bir temel oluşturmanızı sağlıyoruz.</p>
									<p>Bas gitar derslerimizde, başlangıç seviyesinde temel parmak egzersizleri, basit ritimler ve skalalar üzerine yoğunlaşırız. Bu seviyede öğrenciler, bir şarkının ritim yapısını anlamayı ve kolay parçalar çalmayı öğrenir. Orta seviyede slap teknikleri, walking bass çalışmaları ve şarkı düzenlemeleri işlenir. İleri seviyede ise karmaşık groove’lar, doğaçlama becerileri ve sahne performansı için gerekli profesyonel düzeyde teknikler geliştirilir. Bas gitar derslerimiz, her seviyede öğrencilerimizin özgüvenlerini artırmalarına ve güçlü bir müzikal altyapı oluşturmalarına destek olur.</p>
									<br>
							...
							<aside class="sidebar">
									<div class="widget">
										<h3 class="widget-title">Bas Gitar Öğretmenlerimiz</h3>
										<ul class="discography-list">
											<li>
												<figure class="cover"><img src="dummy/bass-teacher1.png" alt="thumbnail 1"></figure>
												<div class="detail">
													<h3 id="teacher">Tuna Aksoy</h3>
													<span class="year">Rock</span>
													<span class="track">Başlangıç Seviyesi</span>
												</div>
											</li>
											<li>
												<figure class="cover"><img src="dummy/bass-teacher2.jpg" alt="thumbnail 2"></figure>
												<div class="detail">
													<h3 id="teacher">Oğuzhan Canpolat</h3>
													<span class="year">Klasik</span>
													<span class="track">Orta Seviye</span>
												</div>
											</li>
											<li>
												<figure class="cover"><img src="dummy/bass-teacher3.jpg" alt="thumbnail 3"></figure>
												<div class="detail">
													<h3 id="teacher">Kaan Şener</h3>
